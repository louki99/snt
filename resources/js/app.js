...
// import '../theme/js/vendor/jquery-3.5.1.min';
import '../theme/js/vendor/slick.min';
import '../theme/js/vendor/jquery.ticker';
import '../theme/js/vendor/jquery.vticker-min';
import '../theme/js/vendor/jquery.nice-select.min';
import '../theme/js/vendor/jquery.magnific-popup';
// import '../theme/js/vendor/wow.min';
import '../theme/js/vendor/jquery.scrollUp.min';
import '../theme/js/vendor/jquery.sticky';
import '../theme/js/vendor/perfect-scrollbar';
