<footer class="pt-50 pb-20 bg-grey">
    <div class="container">
            ...
            <div class="col-lg-8 col-md-6">
                <div class="sidebar-widget wow fadeInUp mb-30 animated" style="visibility: visible; animation-name: fadeInUp;">
                    <div class="widget-header-2 position-relative mb-30">
                        <h5 class="mt-5 mb-30">À PROPOS</h5>
                    </div>
                    <div class="textwidget">
                        <p>
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deleniti
                            nemo dolorum vel ipsum rerum voluptas eos iure necessitatibus molestias
                            doloremque. Quia, explicabo quaerat omnis temporibus aspernatur nihil
                            repellat totam enim.
                        </p>
                        <p>
        ...
        <div class="footer-copy-right pt-30 mt-20 wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
            <p class="float-md-left font-small text-muted">©2023 Contrôle sanitaire et qualitatif des viandes d'animaux de boucherie</p>
            <p class="float-md-right font-small text-muted">
              Créé par OUARTASSI Hamza | All rights reserved.
            </p>
        </div>
    </div>
</footer>
